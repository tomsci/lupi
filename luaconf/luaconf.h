...
#define LUA_INT_LONG
#endif
// TOMSCI #define LUA_REAL_FLOAT
#undef LUA_INT_INT // TOMSCI
#define LUA_INT_LONG // TOMSCI
...
// TOMSCI #error "numeric real type not defined"
//BEGIN TOMSCI

#ifndef LUA_INT_LONG
#error "Definitions wrong, LUA_INT_LONG must be defined!"
#endif
...
#define l_mathop(x)		(__builtin_ ## x)
...
// TOMSCI#define l_floor(x)		(l_mathop(floor)(x))
#define l_floor(x) (x) // TOMSCI
...
//TOMSCI #define luai_numidiv(L,a,b)	((void)L, l_mathop(floor)(luai_numdiv(L,a,b)))
//BEGIN TOMSCI
static inline long luai_numidiv(void* L, long a, long b) {
	// This is tedious...
	if (a < 0 && b > 0) {
		return (a - b + 1) / b;
	} else if (a > 0 && b < 0) {
...
*/
#if 1 // TOMSCI
static inline long luai_nummod_helper(void* L, long a, long b) {
	int numerator;
