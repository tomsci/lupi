...
--[[**
Sets the rotation for subsequent draw commands. If for example `degrees`
is set to 90, drawing to (0, 0) will draw to the top-right pixel.

Equivalent to something like:

	local RotateTransform = require("bitmap.transform").RotateTransform
	b:setTransform(RotateTransform(degrees, b:rawWidth(), b:rawHeight()).get())
]]
