...
uses the definition of raw equality (in Lua 5.2 and earlier), so two Int64s with
...
--[[**
Returns the bottom 32 bits of the value as a Lua number.
]]
--native function Int64:lo()

--[[**
Returns the top 32 bits of the value as a Lua number.
]]
--native function Int64:hi()
